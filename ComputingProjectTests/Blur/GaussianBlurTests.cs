...
namespace ComputingProject.Blur.Tests
{
    ...
    public class GaussianBlurTests
    {
        ...
        public void BlurTest()
        {
            ...
            IBlur testingObject = new GaussianBlur();
            pixels = testingObject.Blur(pixels, orgBitmapData, 10, 0, new int[1,1], new Rectangle(), false, false);
            Marshal.Copy(pixels, 0, ptrFirstPixel, pixels.Length);
            orgBitmap.UnlockBits(orgBitmapData);
            orgBitmap.Save("SmallLandscapeGaussian10.png");
        }
    }
}